  ...
  return (
    <div className="flex flex-col gap-6">
          ...
          {destinations.map((dest) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group w-full overflow-hidden rounded-2xl border p-0 text-right transition duration-200",
                  active
                    ? isGeneral
      ...
      <div className="flex flex-col gap-2">
        <Label>مبلغ</Label>
        <p className="text-xs leading-5 text-slate-500">
          حداقل {MIN_DONATION_USDT} USDT — برای مبالغ کم، درگاه ممکن است روی
          ارزی غیر از USDT BEP20 باز شود (محدودیت همان شبکه در NOWPayments)
        </p>
